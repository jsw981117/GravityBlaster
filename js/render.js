class Renderer {
    ...
    renderPreview(previewBlocks) {
        ...
        for (let block of previewBlocks) {
            ...
            totalWidth += (maxX - minX + 1) * cellSize + blockSpacing;
        }
        totalWidth += padding;
        ...
        for (let block of previewBlocks) {
            ...
            maxHeight = Math.max(maxHeight, (maxY - minY + 1) * cellSize);
        }
        ...
        for (let block of previewBlocks) {
            ...
            offsetX += (maxX - minX + 1) * cellSize + blockSpacing;
        }
    }
}
